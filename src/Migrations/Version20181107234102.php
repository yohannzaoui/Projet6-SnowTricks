 ...
 */
final class Version20181107234102 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE trick ADD author_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', DROP author');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE trick ADD author VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, DROP author_id');
    }
}
