 ...
 */
final class Version20181108190443 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_9474526C20E394C2 ON comment (pseudo_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_9474526C20E394C2 ON comment');
